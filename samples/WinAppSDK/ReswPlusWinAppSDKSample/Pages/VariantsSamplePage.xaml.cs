...
namespace ReswPlusWinAppSDKSample.Pages
{
    ...
    public sealed partial class VariantsSamplePage : Page, INotifyPropertyChanged
    {
        ...
        private void PartDayMorning_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            UpdatePartDay(PartDayEnum.MORNING);
        }

        private void PartDayAfternoon_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            UpdatePartDay(PartDayEnum.AFTERNOON);
        }

        private void PartDayEvening_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            UpdatePartDay(PartDayEnum.EVENING);
        }

        private void PartDayNight_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            UpdatePartDay(PartDayEnum.NIGHT);
        }

        private void PetTypeDog_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            UpdatePetType(PetTypeEnum.DOG);
        }

        private void PetTypeCat_Checked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
